...
if(USE_CLANG)
    ...
    set(CMAKE_CXX_LINK_EXECUTABLE "g++ -Wl,--oformat=elf32-i686 -no-pie -nostdlib -fstack-protector -ffreestanding -T ${CMAKE_SOURCE_DIR}/boot32.ld <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS>  -o <TARGET> <LINK_LIBRARIES> ")
endif(USE_CLANG)
