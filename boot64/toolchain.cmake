...
if(USE_CLANG)
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -target x86_64-pc-none-elf -nostdinc -mno-red-zone -nostdlib -ffreestanding -fno-sanitize=all -DCLANG")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -target x86_64-pc-none-elf -nostdinc -mno-red-zone -nostdlib -ffreestanding -fno-sanitize=all -DCLANG")
    ...
    set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -m64 -march=x86-64 -nostdinc -mno-red-zone -nostdlib -ffreestanding")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m64 -march=x86-64 -nostdinc -mno-red-zone -nostdlib -ffreestanding")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m64 -march=x86-64 -nostdinc -mno-red-zone -nostdlib -ffreestanding")
