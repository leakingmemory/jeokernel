...
// The boot state captured from Stage1Data (multiboot_info, the uefi*/efi_*/
// kernel_* fields and loaderGdtAddr) lives in arch/x86_64/bootstrap.cpp now,
// alongside start_m64() which fills it in; see arch/x86_64/bootstrap.h.
