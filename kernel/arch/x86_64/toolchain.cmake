...
if(USE_CLANG)
    ...
    IF(${CMAKE_SYSTEM_NAME} STREQUAL "FreeBSD")
        set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_LINKER> -nostdlib --pic-executable -T ${CMAKE_CURRENT_LIST_DIR}/kernel.ld <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS>  -o <TARGET> <LINK_LIBRARIES>")
    ELSE()
        set(CMAKE_CXX_LINK_EXECUTABLE "${CMAKE_CXX_COMPILER} -target x86_64-pc-none-elf -mno-red-zone -nostdinc -fPIC -nostdlib -fuse-ld=lld -ffreestanding -fno-stack-protector -T ${CMAKE_CURRENT_LIST_DIR}/kernel.ld <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS>  -o <TARGET> <LINK_LIBRARIES> -lgcc")
    ENDIF()
else(USE_CLANG)
    ...
    set(CMAKE_CXX_LINK_EXECUTABLE "g++ -Wl,--oformat=elf64-x86-64 -nostdlib -fPIC -mno-red-zone -fstack-protector -ffreestanding -T ${CMAKE_CURRENT_LIST_DIR}/kernel.ld <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS>  -o <TARGET> <LINK_LIBRARIES>")
endif(USE_CLANG)
