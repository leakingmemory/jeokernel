...
reference<FileDescriptor> StdinDesc::Descriptor(const std::shared_ptr<class referrer> &referrer, std::shared_ptr<class tty> tty) {
    ...
    return FileDescriptor::CreateFromPointer(referrer, fdhandler, 0, O_RDONLY);
}
